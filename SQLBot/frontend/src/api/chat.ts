...
export class ChatRecord {
  ...
  duration?: number
  total_tokens?: number
  execution_steps?: Array<ChatExecutionStep>
  ...
  constructor(
    ...
    execution_steps?: Array<ChatExecutionStep> | undefined
  )
  constructor(
    id?: number,
    chat_id?: number,
...
export type ChatExecutionStepStatus = 'running' | 'success' | 'error' | 'skipped'
