    ...
    <div class="top-tab-container">
      <div class="flex-top-tabs">
        ...
        <div class="tab-card active">
          <div :title="pageName || '小爱同学'" class="active-span">
            <img :src="pageWeb" alt="" />
            <span>{{ pageName || '小爱同学' }}</span>
          </div>
          <el-icon size="10">
            <icon_close_outlined />
          </el-icon>
          ...
          <div class="config-area">
            <div class="login-logo">
              <div class="login-logo-icon">
                ...
                <BrandLogo v-else width="150px" height="52px" />
                <span
...
import logoHeader from '@/assets/weallstar.png'
...
const pageWeb = computed(() => {
  return !props.web
    ? props.isBlue
      ? logoHeader
      : `${location.pathname}weallstar.png`
