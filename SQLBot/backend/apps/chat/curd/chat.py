...
def format_json_data(origin_data: dict):
    ...
    result['data'] = data
    if origin_data.get('profile'):
        result['profile'] = origin_data.get('profile')
    if origin_data.get('limit'):
        result['limit'] = origin_data.get('limit')
    if origin_data.get('datasource'):
        result['datasource'] = origin_data.get('datasource')
    if origin_data.get('sql'):
        result['sql'] = origin_data.get('sql')
    if origin_data.get('dimensions'):
        result['dimensions'] = origin_data.get('dimensions')
